    ...
    if audio_hash != st.session_state.last_audio_processed:
        ...
        with st.spinner("🎧 Transcribing audio..."):
            try:
                ...
                # Transcribe audio
                transcribed_text, detected_lang = speech_to_text(temp_audio_path, st.session_state.selected_language)
                # Clean up temp file
                try:
    ...
    with st.chat_message("assistant"):
        with st.spinner("🤔 Thinking..."):
            try:
                ...
                result = get_response(prompt, vector_store, st.session_state.selected_language)
